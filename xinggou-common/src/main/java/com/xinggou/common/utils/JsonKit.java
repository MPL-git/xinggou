...
import com.xinggou.common.core.CPI;
...
public class JsonKit {
    ...
    private static String otherToJson(Object value, int depth) {
        ...
        if (value instanceof Model) {
            Map map = beanToMap(value);
            map.putAll(CPI.getAttrs((Model) value));
            Set<String> removeAttrs = CPI.getRemoveAttrs((Model) value);
    ...
    public static Map beanToMap(Object model) {
        Map map = new HashMap();
